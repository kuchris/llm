...
DEFAULT_TRAIN_OUTPUT_PATH = "data/alpaca_cleaned_train_eos_sft.txt"
DEFAULT_EVAL_OUTPUT_PATH = "data/alpaca_cleaned_eval_eos_sft.txt"
...
def main() -> None:
    ...
    def build_text(split_dataset) -> str:
        ...
        for row in split_dataset:
            examples.append(format_example(row["instruction"], row["input"], row["output"] + EOS_TOKEN))
        return "\n".join(examples)
